...
$destinatario = 'andresibanez@aimcafe.com.co'; // en esta línea va el mail del destinatario, puede ser una cuenta de hotmail, yahoo, gmail, etc
...
<?php
    ...
    $cuerpo .= "Cantidad sacos: " . $_POST["cantidad"] . "\r \n";
